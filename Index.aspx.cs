    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        if (ctrlGoogleReCaptcha.Validate())
        {
            try
            {
                ...
                stringBuilder.Append("</td></tr></table><br/><br/><b style='font-size:14px;width:30%;padding: 8px;line-height: 1.42857143;vertical-align: top;'>Message </b>: <span style='font-size:14px;width:30%;padding: 8px;line-height: 1.42857143;vertical-align: top;'>" + this.txtmessage.Text.Trim() + "</span></br>");
